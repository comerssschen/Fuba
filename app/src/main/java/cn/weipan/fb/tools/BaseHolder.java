...
public class BaseHolder extends RecyclerView.ViewHolder {
     ...
     * @return BaseHolder
     */
    public BaseHolder setText(@IdRes int viewId, String text) {
        TextView textView = (TextView) getView(viewId);
        if (text != null) {
     ...
     * @return BaseHolder
     */
    public BaseHolder setText(@IdRes int viewId, SpannableStringBuilder text) {
        TextView textView = (TextView) getView(viewId);
        if (text != null) {
            textView.setText(text);
        } else {
     ...
     * @return BaseHolder
     */
    public BaseHolder setBackgroundColor(@IdRes int viewId, @ColorLong int color) {
     ...
     * @return BaseHolder
     */
    public BaseHolder setBackgroundResource(@IdRes int viewId, @DrawableRes int backgroundRes) {
        View view = getView(viewId);
     ...
     * @return BaseHolder
     */
    public BaseHolder setBackgroundDrawable(@IdRes int viewId, Drawable drawable) {
        View view = getView(viewId);
        if (drawable != null) {
     ...
     * @return BaseHolder
     */
    public BaseHolder setTextColor(@IdRes int viewId, @ColorLong int textColor) {
        TextView textView = (TextView) getView(viewId);
     ...
     * @return BaseHolder
     */
    public BaseHolder setAlpha(@IdRes int viewId, @FloatRange(from = 0.0, to = 1.0) float
            value) {
     ...
     * @return BaseHolder
     */
    public BaseHolder setOnClickListener(@IdRes int viewId, @NonNull View.OnClickListener
            listener) {
        View view = getView(viewId);
        if (listener != null) {
     ...
     * @return BaseHolder
     */
    public BaseHolder setOnTouchListener(@IdRes int viewId, @NonNull View.OnTouchListener
            listener) {
        View view = getView(viewId);
        if (listener != null) {
     ...
     * @return BaseHolder
     */
    public BaseHolder setOnLongClickListener(@IdRes int viewId, @NonNull View
            .OnLongClickListener
            listener) {
        View view = getView(viewId);
        if (listener != null) {
